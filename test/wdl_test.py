...
model = WDL(linear_feature_columns=linear_feature_columns, dnn_feature_columns=fixlen_feature_columns,
...
plt.title('deep & wide loss curve')
plt.show()
