...
from deepctr_torch.models.ifm import IFM
...
# 4 IFM训练,其中linear_feature_columns只是为继承基类
model = IFM(linear_feature_columns=linear_feature_columns, dnn_feature_columns=fixlen_feature_columns,
...
IFM(
  ...
  (transform_weight_matrix_P): Linear(in_features=128, out_features=26, bias=False)
)
"""
